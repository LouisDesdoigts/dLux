...
The Spectrum class is a generic class that allows for the definition of
spectra by a simple wavelength and weights. The PolySpectrum class provides a
generic polynomial spectrum.
