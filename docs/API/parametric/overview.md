...
classDiagram
    ...
    click dLux_parametric_bases_SplineBasis href "../bases/#dLux.parametric.bases.SplineBasis" "Attributes: coefficients, basis_shape, knot_coords, sample_coords, method · Methods: calculate_basis(), evaluate()"
