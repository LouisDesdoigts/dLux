...
```mermaid
classDiagram
    class dLux_base["base"]
    click dLux_base href "../core/base/" "Public classes: Base"
    ...
    class dLux_compatibility["compatibility"]
    click dLux_compatibility href "../core/compatibility/" "Public classes: ABCDConjugatePlane, ASMPropagator, AberratedAperture, AngularOpticalSystem, BaseDetector, BaseOpticalSystem, BaseSpectrum, BasisLayer, BasisOptic, CartesianOpticalSystem, CircularAperture, CompoundAperture, CoordSpec, DistortedCoords, Dither, FFT, FFTPropagator, Instrument, LayeredDetector, LayeredOpticalSystem, MFT, MFTPropagator, MultiAperture, PadSpec, ParametricOpticalSystem, PointResolvedSource, PointSource, PointSources, PolySpectrum, RectangularAperture, RegPolyAperture, ResolvedSource, Rotate, Scene, SquareAperture, Telescope, Zernike"
    ...
    click dLux_grids href "../core/grids/" "Public classes: CoordTransform, BaseGridSpec, GridSpec, ResizeSpec, PasteSpec, CoordTransform, Affine, AffineMap, TransformChain, DistortCoords"
    ...
    class dLux_layers_coronagraphy["layers.coronagraphy"]
    click dLux_layers_coronagraphy href "../layers/coronagraphy/" "Public classes: SoummerFPM"
    ...
    click dLux_layers_optical href "../layers/optical/" "Public classes: BaseLayer, BaseOpticalLayer, OpticalLayer, TransmissiveLayer, AberratedLayer, Optic, Tilt"
    ...
    click dLux_parametric_bases href "../parametric/bases/" "Public classes: ParametricBasis, Basis, PastedBasis, ImplicitBasis, CoordBasis, CLIMBBasis, FourierBasis, SplineBasis"
    ...
    click dLux_parametric_shapes href "../parametric/shapes/" "Public classes: Shape, InvertibleShape, Hard, Soft, Circle, Square, Rectangle, RegularPolygon, Spider, Complement, TransformedShape"
    ...
    dLux_base <|-- dLux_builders
    dLux_base <|-- dLux_fields
    dLux_base <|-- dLux_grids
    dLux_base <|-- dLux_layers_propagation
    dLux_base <|-- dLux_parametric_parametrics
    dLux_base <|-- dLux_parametric_polynomials
    dLux_base <|-- dLux_parametric_shapes
    dLux_base <|-- dLux_systems
    dLux_builders <|-- dLux_prebuilt
    dLux_grids <|-- dLux_compatibility
    dLux_layers_detector <|-- dLux_layers_unified
    dLux_layers_dynamic <|-- dLux_layers_sparse
    dLux_layers_optical <|-- dLux_layers_coronagraphy
    ...
    dLux_layers_propagation <|-- dLux_compatibility
    ...
    dLux_sources <|-- dLux_compatibility
    dLux_systems <|-- dLux_compatibility
```
