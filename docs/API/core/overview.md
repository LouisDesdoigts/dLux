...
classDiagram
    ...
    click dLux_fields_BaseField href "../fields/#dLux.fields.BaseField" "Attributes: spec · Methods: field(), set_field(), spatial_shape(), axes(), coordinates(), xs(), npixels(), pixel_scale(), center(), diameter(), normalise(), convolve(), resize(), downsample(), flip()"
    ...
    click dLux_fields_DiscreteField href "../fields/#dLux.fields.DiscreteField" "Attributes: spec, variance, read_noise · Methods: error(), fourier_transform(), amplitude_spectrum(), power_spectrum(), add_poisson_noise(), add_read_noise(), log_likelihood()"
    dLux_fields_ContinuousField <|-- dLux_fields_Wavefront
    click dLux_fields_Wavefront href "../fields/#dLux.fields.Wavefront" "Attributes: spec, phasor, wavelength · Methods: real(), imaginary(), amplitude(), phase(), complex(), polar(), psf(), wavenumber(), batch_ndim(), is_chromatic(), is_polarised(), power(), add_phase(), add_opd(), tilt(), normalise(), apply_jones(), psf_from_stokes()"
    dLux_fields_Wavefront <|-- dLux_fields_PolarisedWavefront
    click dLux_fields_PolarisedWavefront href "../fields/#dLux.fields.PolarisedWavefront" "Attributes: spec, phasor, wavelength · Methods: is_polarised(), batch_ndim(), from_wavefront(), psf(), psf_from_stokes(), stokes(), apply_jones()"
    dLux_fields_ContinuousField <|-- dLux_fields_PSF
    click dLux_fields_PSF href "../fields/#dLux.fields.PSF" "Attributes: data, spec · Methods: batch_ndim()"
    dLux_fields_DiscreteField <|-- dLux_fields_Image
    click dLux_fields_Image href "../fields/#dLux.fields.Image" "Attributes: data, spec, variance, read_noise"
    click dLux_grids_GridSpec href "../grids/#dLux.grids.GridSpec" "Attributes: n, d, c, unit · Methods: ndim(), broadcast(), shape(), scale(), axes(), axes_for(), coordinates(), coordinates_for(), xs(), xs_for(), fov(), extent()"
    click dLux_grids_ResizeSpec href "../grids/#dLux.grids.ResizeSpec" "Attributes: n, pad_factor, crop_factor, c · Methods: broadcast(), explicit(), padding(), output_size(), crop_size(), pad(), crop(), resize()"
    ...
    click dLux_sources_BaseSource href "../sources/#dLux.sources.BaseSource" "Attributes: flux, distribution, units · Methods: source_params(), distribution_params(), model()"
