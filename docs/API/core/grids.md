...
classDiagram
    ...
    click dLux_grids_ResizeSpec href "#dLux.grids.ResizeSpec" "Attributes: n, pad_factor, crop_factor, c · Properties: explicit, padding · Methods: broadcast(), output_size(), crop_size(), pad(), crop(), resize()"
